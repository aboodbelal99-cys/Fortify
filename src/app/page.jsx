...
export default function HomePage() {
  ...
  const whyFortifyItems = t('whyFortify.items');
  const processSteps = t('process.steps');

  // SVG icons for Why Fortify section (language-independent)
  const whyIcons = [
    <svg key="1" className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" /></svg>,
    <svg key="2" className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" /></svg>,
  ...
  return (
    <>
      ...
      <section id="services" className="py-24 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            ...
            highlight={t('servicesSection.highlight')}
      ...
      <section id="why-fortify" className="py-24 relative bg-navy-dark/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            title={t('whyFortify.title')}
            highlight={
              <>
                {t('whyFortify.highlight')}{' '}
                <span className="font-bold">
                  <span className="text-white" style={{ WebkitTextFillColor: 'white' }}>Fort</span>
                  <span style={{ WebkitTextFillColor: '#E8B95E' }}>ify</span>
                </span>
              </>
            }
            description={t('whyFortify.description')}
          />

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Array.isArray(whyFortifyItems) && whyFortifyItems.map((item, index) => (
              <div
                key={index}
